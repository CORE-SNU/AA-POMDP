...
def dqn_learning(env,
    ...
    for t in itertools.count():
        ...
        if t < learning_starts:
            ...
            # epsilon greedy exploration - following "Leverage the Average"
            ...
            if sample > threshold:
                ...
                # if mellowmax:
                if False: # Just use maximizer! - Neurips'21 paper version!
                    action = mellowmax_policy(q_value_all_actions, lamb=lamb)
                else:
