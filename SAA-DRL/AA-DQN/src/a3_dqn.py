...
from src.anderson_alpha import A3
from utils.reg_bellman import *
...
def dqn_learning(env,
    ...
    # initialize anderson
    anderson = A3(MAX_NUM, use_restart, reg_scale)
    ...
    # RUN ENV     #
    ###############
    interval = safeguard_freq
    opt_gain, opt_obj = 0, 0
    num_param_updates = 0
    ...
    for t in itertools.count():
        ...
        # TODO: Implement soft maximum for DuelingDQN!
        ...
        if (t > learning_starts and
            ...
            if restart:
                ...
                if mellowmax:
                    q_s_a_prime = mellowmax_maximum(q_tp1_values, lamb=lamb)
                else:
                ...
                for i in range(num, 0, -1):
                    ...
                    if mellowmax:
                        q_next_aa = mellowmax_maximum(q_target[sample_size:, :], lamb=lamb)
                    else:
                ...
                alpha, restart, opt_gain, opt_obj = anderson.calculate(qs_target_t_values, F_qs_target_t)
                
                if opt_gain > theta_thres and num_param_updates % interval == 0:
                    alpha = 0*alpha
